...
def fetchNovelsList(sort, order, status, page):
    ...
    def response(sort, order, status, page):
        my_url = "https://www.novelupdates.com/novelslisting/?sort={}&order={}&status={}&pg={}".format(sort, order, status, page)
    ...
    return response(sort, order, status, page)